...
public class BaseItems {
	...
	public Item coins = new Item("Coins", "Buy stuff with coins.", 0, 0, 1, false);
	...
	public BaseItems()
	{
		items = new Item[]{coins, tools, clothes, books, games, cellPhone, condoms, birthControl, sportsEquipment};
	}
}
